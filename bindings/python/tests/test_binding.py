...
class TestAsciiMathExamples(TestCase):
    ...
    def __init__(self, methodName: str = "test_examples") -> None:
        ...
        self.examples = [
            ...
            {
                'i': '{ a | b }',
                'o': '\\left\\lbrace a | b\\right\\rbrace',
            },
            {
                'i': '(a,b)',
                'o': '\\left(a , b\\right)',
            ...
            {
                'i': '{(x,y)|x^2+y^2<=1}',
                'o': '\\left\\lbrace \\left(x , y\\right) | x^{2} + y^{2} \\le 1\\right\\rbrace',
            },
            {
                'i': '|(a, b), (c, d)|',
                'o': '\\left|\\begin{array}{cc} a & b \\\\ c & d \\end{array}\\right|',
            },
            {
                ...
                'o': '| x | = \\left\\lbrace \\begin{array}{ll} x & \\text{if}\\quad x \\gt 0 \\\\ - x & \\text{otherwise} \\end{array}\\right.',
            },
            {   # TODO
                'i': 'e^-x',
                'o': 'e^{-x}',
